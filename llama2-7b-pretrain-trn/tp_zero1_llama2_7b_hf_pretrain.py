...
def train_llama(flags):
    ...
    nxd_config = nxd.neuronx_distributed_config(
        ...
        activation_checkpoint_config=(
            CoreAttention if flags.selective_checkpoint_enabled else "full"
        ),
    ...
    optimizer = nxd.initialize_parallel_optimizer(
        nxd_config, optimizer_cls, optimizer_grouped_parameters, lr=flags.lr
    )
    optimizer.zero_grad()
                ...
                if args.force_checkpoint or (
                    ...
                    xm.add_step_closure(
                        ...
                        (
                            ...
                            8,  # num_workers, ignored because of use_xser.
                            True,  # use_xser
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--tensor_parallel_size", default=2, type=int, help="Tensor parallel size"
    )
